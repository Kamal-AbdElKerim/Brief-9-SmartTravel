  ...
  <div class=" text-center ">
        <div class="row">
          ...
          <div class="col-sm-12 form">
            <div class="row">
              <form  method="post" enctype="multipart/form-data" action="index.php?action=UpdateRoute">
             ...
             <div class="mt-5">
             <button type="submit" name="submit" class="btn btn-success">Update route</button>
