          ...
          <div class="col-sm-12 form">
            <div class="row">
              ...
              <div class="mb-3">
                ...
                <input name="name" required value="<?= $data[0]["name"] ?>" placeholder="nom..." type="text" class="form-control " id="exampleFormControlInput1" >
                <input style="display: none;" name="id" required value="<?= $data[0]["id"] ?>" placeholder="nom..." type="text" class="form-control " id="exampleFormControlInput1" >
              </div>
              <div class="mb-3">
                <label for="exampleFormControlTextarea1" class="form-label  ">Description</label>
                <textarea name="Bio"  required placeholder="Description..." class="form-control" id="exampleFormControlTextarea1" rows="3"><?= $data[0]["Bio"] ?></textarea>
              </div> 
